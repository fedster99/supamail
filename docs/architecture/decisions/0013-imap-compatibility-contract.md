...
- GreenMail and Dovecot smoke tests for real IMAP protocol behavior
...
- New provider claims require either automated fixture coverage, real-server protocol proof, or a recorded manual smoke result.
...
- `pnpm smoke:dovecot` verifies the real Dovecot IMAP protocol path against seeded Maildir data.
