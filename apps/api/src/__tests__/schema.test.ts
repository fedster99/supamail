...
const searchLayerMigrationPath = resolve(process.cwd(), "supabase/migrations/public/0007_search_layer.sql");
...
describe("initial schema", () => {
  ...
  it("exposes an ordered public migration manifest for hosted deploy gates", async () => {
    ...
    expect(version).toBe("0007_search_layer");
    expect(manifest).toEqual({
      schemaVersion: "0007_search_layer",
      migrations: [
        ...
        { id: "0007_search_layer", file: "0007_search_layer.sql" }
      ]
    });
